...
<font size='6'> 程式＝資料＋指令    </font>   <font size='3'>by 民明書房 noah </font>
<br><br><br><br>
<div style="float:left">
<font size='6'>
簡單說，寫一個程式，<br>
其實和 **寫一段文章**，或是**一篇小說**差不多。
</font>
</div>
...
# 小提醒：讀取檔案、表格：
## 讀取CSV（Comma-separated values：逗號分隔數值）
### 表格名稱 = read.csv("讀取的檔案")
```{r, fig.width=6, fig.height=3}
...
## 文青的時間 1
<center><img src="img/bigdata2.png" height="60%" width="60%"></center>
<center><img src="img/bigdata1.jpg" height="60%" width="60%"></center>
